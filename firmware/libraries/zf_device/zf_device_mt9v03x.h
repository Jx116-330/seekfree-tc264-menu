...
extern uint8    mt9v03x_image_snapshot[2][MT9V03X_H][MT9V03X_W];
extern volatile uint8 mt9v03x_image_snapshot_index;
extern volatile uint32 mt9v03x_frame_count;
//================================================声明 MT9V03X 全局变量================================================
...
/* Runtime writes: CPU0/main loop only, after successful init.
 * start: 0=accepted, 1=busy/invalid; poll until SUCCESS/ERROR (consumed once).
 * UART waits yield; SCCB still makes one vendor synchronous call.
 * Do not mix with legacy configuration calls while a transaction is active.
 */
typedef enum
{
    MT9V03X_WRITE_EXPOSURE = 0,
    MT9V03X_WRITE_REGISTER
} mt9v03x_write_kind_enum;
typedef enum
{
    MT9V03X_WRITE_IDLE = 0,
    MT9V03X_WRITE_BUSY,
    MT9V03X_WRITE_SUCCESS,
    MT9V03X_WRITE_ERROR
} mt9v03x_write_status_enum;
