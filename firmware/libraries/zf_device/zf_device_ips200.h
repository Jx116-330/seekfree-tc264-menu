...
//==================================================定义 IPS200 基本配置================================================
#define IPS200_USE_SOFT_SPI             (0 )                                    // 使用硬件 SPI，方式与老工程一致
...
//====================================================硬件 SPI 驱动====================================================
// 如果使用的是SPI 串口的两寸屏幕 SPI 驱动控制引脚 可以修改
#define IPS200_SPI_SPEED                (60*1000*1000)                           // match reference hardware SPI speed  
...
#define IPS200_SDA_IN_PIN_SPI           (SPI2_MISO_P15_4 )                      // 硬件 SPI MISO 引脚  IPS没有MISO引脚，但是这里任然需要定义，在spi的初始化时要使用
//====================================================硬件 SPI 驱动====================================================
#endif
// 如果使用的是SPI 串口的两寸屏幕 SPI 驱动控制引脚 可以修改
#define IPS200_RST_PIN_SPI              (P15_1)                                 // (SPI串口)液晶复位引脚定义
#define IPS200_DC_PIN_SPI               (P15_2)                                 // SPI LCD DC
#define IPS200_CS_PIN_SPI               (P15_0)                                 // SPI LCD CS
